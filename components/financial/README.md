...
- `GET /api/financial/customers` - Get customer financial data
- `POST /api/financial/payment` - Record a new payment
- `PATCH /api/financial/balance/:customerId` - Adjust customer balance

See [API Documentation](./api-documentation.md) for detailed endpoint specifications.
